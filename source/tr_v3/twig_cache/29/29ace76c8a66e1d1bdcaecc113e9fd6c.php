...
/* tr-car-rentals/views/stepper_personal_details.html */
class __TwigTemplate_77f0267ba7f45dcfbfe91008425e95c1 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("_layout_fomantic.html", "tr-car-rentals/views/stepper_personal_details.html", 1);
  ...
  <div class=\"ui segment\">
    ...
    <form method=\"post\" action=\"/modules/car-rentals/checkout/personal-details\" class=\"ui form\">
...
";
    ...
    {
        return "tr-car-rentals/views/stepper_personal_details.html";
    }
    ...
    {
        return new Source("", "tr-car-rentals/views/stepper_personal_details.html", "/mnt/BLOCKSTORAGE/home/359206.cloudwaysapps.com/srxrwayjxu/public_html/modules/tr-car-rentals/views/stepper_personal_details.html");
    }
}
