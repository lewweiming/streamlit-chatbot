...
/* tr-flight-bookings/views/stepper_review_payment.html */
class __TwigTemplate_6a4ca31d7e367d2bb1ae8c4f88662480 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("_layout_fomantic.html", "tr-flight-bookings/views/stepper_review_payment.html", 1);
    ...
    <div class=\"ui ordered fluid steps\">
        ...
        <a href=\"/modules/flight-bookings/checkout/personal-details\" class=\"completed step\">
            <div class=\"content\">
...
<table class=\"ui celled table\">
    ...
    <tbody>
        <tr>
            <td><strong>Selected Flight</strong></td>
            <td><span>";
        // line 82
        echo twig_escape_filter($this->env, twig_capitalize_string_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["bookingData"] ?? null), "flight", [], "any", false, false, false, 82)), "html", null, true);
        echo "</span></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><span>";
        // line 94
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["bookingData"] ?? null), "passengers", [], "any", false, false, false, 94), "html", null, true);
        echo "</span></td>
        </tr>
        <tr>
            ...
            <td><span>";
        // line 98
        echo twig_escape_filter($this->env, twig_capitalize_string_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["bookingData"] ?? null), "travelClass", [], "any", false, false, false, 98)), "html", null, true);
        echo "</span></td>
        </tr>
        <tr>
            ...
            <td><span>";
        // line 102
        echo (((twig_get_attribute($this->env, $this->source, ($context["bookingData"] ?? null), "insurance", [], "any", false, false, false, 102) == "true")) ? ("Yes") : ("No"));
        echo "</span></td>
        </tr>
        <tr>
            ...
            <td><span>";
        // line 106
        echo (((twig_get_attribute($this->env, $this->source, ($context["bookingData"] ?? null), "luggage", [], "any", false, false, false, 106) == "true")) ? ("Yes") : ("No"));
        echo "</span></td>
        </tr>
        <tr>
            ...
            <td><span>";
        // line 110
        echo (((twig_get_attribute($this->env, $this->source, ($context["bookingData"] ?? null), "wifi", [], "any", false, false, false, 110) == "true")) ? ("Yes") : ("No"));
        echo "</span></td>
        </tr>
        <tr>
                ...
                <div class=\"ui inverted segment\">
                    ...
                    <table class=\"ui celled table\">
                        <tr>
                            ...
                            <td>";
        // line 129
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["bookingData"] ?? null), "name", [], "any", false, false, false, 129), "html", null, true);
        echo "</td>
                        </tr>
                        <tr>
                            ...
                            <td>";
        // line 133
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["bookingData"] ?? null), "email", [], "any", false, false, false, 133), "html", null, true);
        echo "</td>
                        </tr>
                        <tr>
                            ...
                            <td>";
        // line 137
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["bookingData"] ?? null), "phone", [], "any", false, false, false, 137), "html", null, true);
        echo "</td>
                        </tr>
                    </table>
...
<div class=\"ui relaxed divided list\">
    <div class=\"item\">
        ...
        <div class=\"content\">
            <div class=\"header\">Travel Class</div>
            <div class=\"description\">";
        // line 156
        echo twig_escape_filter($this->env, twig_capitalize_string_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["bookingData"] ?? null), "travelClass", [], "any", false, false, false, 156)), "html", null, true);
        echo "</div>
        </div>
    </div>
    <div class=\"item\">
        ...
        <div class=\"content\">
            <div class=\"header\">Flight Dates</div>
            <div class=\"description\">
                ";
        // line 164
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["bookingData"] ?? null), "departureDate", [], "any", false, false, false, 164), "M j, Y"), "html", null, true);
        echo " -
                ";
        // line 165
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["bookingData"] ?? null), "returnDate", [], "any", false, false, false, 165), "M j, Y"), "html", null, true);
        echo " ( ";
...
";
    ...
    {
        return "tr-flight-bookings/views/stepper_review_payment.html";
    }
    ...
    {
        return array (  358 => 252,  354 => 251,  307 => 206,  271 => 173,  258 => 165,  254 => 164,  243 => 156,  221 => 137,  214 => 133,  207 => 129,  189 => 114,  182 => 110,  175 => 106,  168 => 102,  161 => 98,  154 => 94,  147 => 90,  140 => 86,  133 => 82,  51 => 4,  47 => 3,  36 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "tr-flight-bookings/views/stepper_review_payment.html", "/mnt/BLOCKSTORAGE/home/359206.cloudwaysapps.com/srxrwayjxu/public_html/modules/tr-flight-bookings/views/stepper_review_payment.html");
    }
}
