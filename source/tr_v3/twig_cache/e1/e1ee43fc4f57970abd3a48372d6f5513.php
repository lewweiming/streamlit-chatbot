...
/* tr-hotel-bookings/views/stepper_personal_details.html */
class __TwigTemplate_ea0d7f788b8ec45c1c68f3974e1d5d9b extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("_layout_fomantic.html", "tr-hotel-bookings/views/stepper_personal_details.html", 1);
  ...
  <div class=\"ui segment\">
    ...
    <form method=\"post\" action=\"/modules/hotel-bookings/checkout/personal-details\" class=\"ui form\">
...
";
    ...
    {
        return "tr-hotel-bookings/views/stepper_personal_details.html";
    }
    ...
    {
        return new Source("", "tr-hotel-bookings/views/stepper_personal_details.html", "/mnt/BLOCKSTORAGE/home/359206.cloudwaysapps.com/srxrwayjxu/public_html/modules/tr-hotel-bookings/views/stepper_personal_details.html");
    }
}
