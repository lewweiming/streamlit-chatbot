...
/* tr-trip-bookings/views/stepper_personal_details.html */
class __TwigTemplate_ca7582c090986f082499d8d94c46d803 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("_layout_fomantic.html", "tr-trip-bookings/views/stepper_personal_details.html", 1);
  ...
  <div class=\"ui breadcrumb\">
    ...
    <a href=\"/modules/trip-bookings\" class=\"section\">Trip Bookings</a>
    <i class=\"right angle icon divider\"></i>
  ...
  <div class=\"ui segment\">
    ...
    <form method=\"post\" action=\"/modules/trip-bookings/checkout/personal-details\" class=\"ui form\">
...
";
    ...
    {
        return "tr-trip-bookings/views/stepper_personal_details.html";
    }
    ...
    {
        return new Source("", "tr-trip-bookings/views/stepper_personal_details.html", "/mnt/BLOCKSTORAGE/home/359206.cloudwaysapps.com/srxrwayjxu/public_html/modules/tr-trip-bookings/views/stepper_personal_details.html");
    }
}
