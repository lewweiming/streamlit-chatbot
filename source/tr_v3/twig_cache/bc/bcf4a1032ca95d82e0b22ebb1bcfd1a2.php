...
/* discussion-board/views/admin/manage_categories.html */
class __TwigTemplate_d69bfb47263c7096306e201720f7bcf0 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("_layout_admin_fomantic.html", "discussion-board/views/admin/manage_categories.html", 1);
...
";
    ...
    {
        return "discussion-board/views/admin/manage_categories.html";
    }
    ...
    {
        return new Source("", "discussion-board/views/admin/manage_categories.html", "/mnt/BLOCKSTORAGE/home/359206.cloudwaysapps.com/srxrwayjxu/public_html/modules/discussion-board/views/admin/manage_categories.html");
    }
}
