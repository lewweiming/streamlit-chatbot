...
/* customer-support/views/admin/customer_request_dashboard_manager.html */
class __TwigTemplate_62bca61539d42c7035b66ae8aba168dd extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("_layout_admin_fomantic.html", "customer-support/views/admin/customer_request_dashboard_manager.html", 1);
...
";
    ...
    {
        return "customer-support/views/admin/customer_request_dashboard_manager.html";
    }
    ...
    {
        return new Source("", "customer-support/views/admin/customer_request_dashboard_manager.html", "/mnt/BLOCKSTORAGE/home/359206.cloudwaysapps.com/srxrwayjxu/public_html/modules/customer-support/views/admin/customer_request_dashboard_manager.html");
    }
}
