...
/* tr-car-rentals/views/admin/bookings/add_booking.html */
class __TwigTemplate_f0c476bfba93a1b4850ad80d2a09656e extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("_layout_admin_fomantic.html", "tr-car-rentals/views/admin/bookings/add_booking.html", 1);
...
";
    ...
    {
        return "tr-car-rentals/views/admin/bookings/add_booking.html";
    }
    ...
    {
        return new Source("", "tr-car-rentals/views/admin/bookings/add_booking.html", "/mnt/BLOCKSTORAGE/home/359206.cloudwaysapps.com/srxrwayjxu/public_html/modules/tr-car-rentals/views/admin/bookings/add_booking.html");
    }
}
