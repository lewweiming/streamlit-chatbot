...
$booking_data = $tripBookingSession->getBooking(1);

// Example array from session manager
// destination => string (5) "tokyo"
// departureDate => string (10) "2024-10-18"
// returnDate => string (10) "2024-10-17"
// travelers => string (1) "1"
// hotelBooking => string (4) "true"
...
$booking = [
    ...
    'start_date' => $booking_data['departureDate'],
    'end_date' => $booking_data['returnDate'],
    'travelers' => $booking_data['travelers'],
    'hotel_booking' => $booking_data['hotelBooking'] == 'true'?1:0, // addon
    'car_rental' => $booking_data['carRental'] == 'true'?1:0, // addon
    'status' => 'pending', // Default
    'total_amount' => getBookingTotal($booking_data) // 100.00
];

$lastId = TripBooking::insert($booking);
...
CashierReceipt::insert([
    ...
    'description' => "Trip Booking Payment (Booking Id: $lastId)",
...
$tripBookingSession->clearBookings();
