...
class TripBooking extends Model
{
    ...
    {
        $rows = parent::$db->table('trips_bookings')->getAll();
    ...
    {
        $result = parent::$db->table('trips_bookings')->where('title', $title)->get();
    ...
    {
        $results = parent::$db->table('trips_bookings')->where('user_id', $user_id)->getAll();
    ...
    {
        parent::$db->table('trips_bookings_modifications')->insert($payload);
    ...
    {
        parent::$db->table('trips_bookings_cancellations')->insert($payload);
    ...
    {
        parent::$db->table('trips_bookings')->insert($payload);
    ...
    {
        parent::$db->table('trips_bookings')->where('id', $id)->update($payload);
    }

    public static function delete($id)
    {
        parent::$db->table('trips_bookings')->where('id', $id)->delete();
    }

    public static function find($id)
    {
        $result = parent::$db->table('trips_bookings')->where('id', $id)->get();
    ...
    {
        $results = parent::$db->table('trips_bookings')->where($column, $value)->getAll();
    ...
    {
        $result = parent::$db->table('trips_bookings')->where($column, $value)->get();
