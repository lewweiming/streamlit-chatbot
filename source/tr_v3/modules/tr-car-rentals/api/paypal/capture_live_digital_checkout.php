...
// Receipt Link: https://www.paypal.com/activity/payment/51649387RP562621C
...
$r = PaypalDigitalCheckout::curlCaptureLivePurchase($orderId);
...
// 'customer_name' => $customer_data['firstName'],
    ...
    'digital_receipt_url' => "https://www.paypal.com/activity/payment/" . $paypal_transaction_id
]);
...
Pushover::send('IKA: New listing upgrade purchased (live)');
