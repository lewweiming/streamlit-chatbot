...
class ModuleManagerController extends CoreController
{
    /*
    ...
    */
    ...
    function admin()
    {
        ...
        if(!$modules) {
            ...
            $modules = [];
            Flash::add('error', 'An error has occurred retrieving the module list');
        }

        $installed_modules = Module::all();

        return $this->twig->render('module-manager/views/admin/index.html', ['modules' => $modules, 'installed_modules' => $installed_modules]);
    }

    function showWorkflow()
    {
        return $this->twig->render('module-manager/views/admin/workflow.html');
    }
