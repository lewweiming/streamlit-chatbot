...
$paypal_payload = [
    ...
    'description' => 'This is a digital resource purchase on iKnowAll',

    'items' => [
        [
            'name' => 'iKnowAll Digital Resource',
            'description' => "IKNOWALL-ID-" . $listing->id,
            'quantity' => 1,
            'unit_amount' => [
                'currency_code' => 'USD',
...
$r = PaypalDigitalCheckout::curlCreateLivePurchase($paypal_payload, $amount);
